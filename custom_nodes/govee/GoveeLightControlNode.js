...
class GoveeLightControlNode extends LiteGraph.LGraphNode {
    constructor() {
        ...
        this.size = [336, 200]; // Increased size for additional properties

        // Initialize properties
        this.properties = {
            device_id: "G123456789",  // Example Device ID
            device_name: "Living Room Govee",
            device_model: "H6102",
            brightness: 100,
        ...
        if (hsv !== undefined) {
            ...
            if (JSON.stringify(newColor) !== JSON.stringify(this.lastColor)) {
                ...
                this.debounceTimeout = setTimeout(() => {
                    ...
                    // Updated lightData structure to include device_type: "govee"
                    let lightData = {
                        device_type: "govee",  // Identify as Govee device
                        device_id: this.properties.device_id,
                        model: this.properties.device_model,
                        control_type: "color", // or "brightness", "switch"
                        bridge_ip: this.properties.bridge_ip || "", // Optional
                    ...
                    console.log("GoveeLightControlNode - Emitting lightData:", lightData);
