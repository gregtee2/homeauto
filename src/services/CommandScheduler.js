...
console.log("CommandScheduler.js loaded successfully.");

class CommandScheduler {
    constructor() {
        this.scheduledCommands = [];
        console.log("CommandScheduler initialized.");
    }
...
/**
 * Optionally, implement additional methods for managing the command queue.
 * For example, retrieving the list of scheduled commands, canceling specific commands, etc.
 */
